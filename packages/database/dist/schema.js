import { pgTable, uuid, varchar, text, timestamp, boolean, decimal, bigint, inet, jsonb, index, uniqueIndex, } from 'drizzle-orm/pg-core';
...
export const emails = pgTable('emails', {
    ...
    indexes: [
        index('emails_mailbox_folder_received_idx').on(t.mailboxId, t.folder, t.receivedAt),
