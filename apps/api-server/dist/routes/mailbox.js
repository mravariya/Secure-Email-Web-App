...
export async function registerMailboxRoutes(app) {
    ...
    app.get('/api/v1/mailboxes/:id/emails', { preHandler: [authenticate] }, async (req, reply) => {
        const userId = req.userId;
    ...
    app.get('/api/v1/mailboxes/:id/threads', { preHandler: [authenticate] }, async (req, reply) => {
        const userId = req.userId;
        const mailboxId = req.params.id;
        const [mailbox] = await db
            .select()
    ...
    app.get('/api/v1/mailboxes/:id/threads/:threadId', { preHandler: [authenticate] }, async (req, reply) => {
        const userId = req.userId;
